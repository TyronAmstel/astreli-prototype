...
{id:101,name:'Vine Marquise Ring',carat:'0.48 ct',metal:'14k Yellow Gold',price:465,color:'Green',kind:'Ring',badge:'NEW',sprite:0,sheet:'electric',description:'A fine golden vine set with vivid green marquise-cut diamonds, winding naturally around the finger.'},
{id:102,name:'Pink Bloom Studs',carat:'0.36 ct',metal:'14k Yellow Gold',price:325,color:'Pink',kind:'Earrings',badge:'NEW',sprite:1,sheet:'electric',description:'Bright pear-cut pink diamonds open into a playful pair of tiny flowers.'},
{id:103,name:'Electric Leaf Pendant',carat:'0.52 ct',metal:'14k White Gold',price:445,color:'Blue',kind:'Necklace',badge:'BESTSELLER',sprite:2,sheet:'electric',description:'Electric-blue marquise diamonds trace a fluid white-gold leaf on a delicate chain.'},
{id:104,name:'Climbing Garden Ear Cuff',carat:'0.31 ct',metal:'14k Yellow Gold',price:275,color:'Rainbow',kind:'Earrings',sprite:3,sheet:'electric',description:'A colourful trail of tiny diamond leaves designed to climb the ear without a piercing.'},
{id:105,name:'Sun Diamond Charm',carat:'0.42 ct',metal:'14k Yellow Gold',price:295,color:'Yellow',kind:'Charm',sprite:4,sheet:'electric',description:'A pocket-sized burst of sunshine, articulated in yellow lab-grown diamonds.'},
{id:106,name:'Blue Garden Line Bracelet',carat:'1.10 ct',metal:'14k White Gold',price:695,color:'Blue Green',kind:'Bracelet',sprite:5,sheet:'electric',description:'Alternating blue and green diamonds create a cool ribbon of colour around the wrist.'},
{id:107,name:'Violet Orchid Ring',carat:'0.38 ct',metal:'Recycled Silver',price:285,color:'Violet',kind:'Ring',sprite:6,sheet:'electric',description:'A hand-finished silver orchid curls around a pear-shaped violet lab-grown diamond.'},
{id:108,name:'Rainbow Garden Huggies',carat:'0.40 ct',metal:'14k Yellow Gold',price:345,color:'Rainbow',kind:'Earrings',sprite:7,sheet:'electric',description:'A joyful garden of coloured diamonds set into polished everyday hoops.'}
];
...
{name:'Electric Garden',desc:'8 vivid pieces where botanical forms meet electric diamond colour.',ids:[101,102,103,104,105,106,107,108]},
